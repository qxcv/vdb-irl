...
def ant_maze(direction=RIGHT, length=6.0):
    ...
    target = worldbody.body(
        name='target', pos=[length / 2, length - 0.2, -0.5])
    target.geom(
        name='target_geom',
        conaffinity=2,
        type='sphere',
    ...
    actuator = mjcmodel.root.actuator()
    actuator.motor(
        ctrllimited="true", ctrlrange="-1.0 1.0", joint="hip_4", gear="50")
    actuator.motor(
        ctrllimited="true", ctrlrange="-1.0 1.0", joint="ankle_4", gear="50")
    actuator.motor(
        ctrllimited="true", ctrlrange="-1.0 1.0", joint="hip_1", gear="50")
    actuator.motor(
        ctrllimited="true", ctrlrange="-1.0 1.0", joint="ankle_1", gear="50")
    actuator.motor(
        ctrllimited="true", ctrlrange="-1.0 1.0", joint="hip_2", gear="50")
    actuator.motor(
        ctrllimited="true", ctrlrange="-1.0 1.0", joint="ankle_2", gear="50")
    actuator.motor(
        ctrllimited="true", ctrlrange="-1.0 1.0", joint="hip_3", gear="50")
    actuator.motor(
        ctrllimited="true", ctrlrange="-1.0 1.0", joint="ankle_3", gear="50")
...
def ant_maze_corridor(direction=RIGHT, height=6.0, width=10.0):
    ...
    actuator = mjcmodel.root.actuator()
    actuator.motor(
        ctrllimited="true", ctrlrange="-1.0 1.0", joint="hip_4", gear="30")
    actuator.motor(
        ctrllimited="true", ctrlrange="-1.0 1.0", joint="ankle_4", gear="30")
    actuator.motor(
        ctrllimited="true", ctrlrange="-1.0 1.0", joint="hip_1", gear="30")
    actuator.motor(
        ctrllimited="true", ctrlrange="-1.0 1.0", joint="ankle_1", gear="30")
    actuator.motor(
        ctrllimited="true", ctrlrange="-1.0 1.0", joint="hip_2", gear="30")
    actuator.motor(
        ctrllimited="true", ctrlrange="-1.0 1.0", joint="ankle_2", gear="30")
    actuator.motor(
        ctrllimited="true", ctrlrange="-1.0 1.0", joint="hip_3", gear="30")
    actuator.motor(
        ctrllimited="true", ctrlrange="-1.0 1.0", joint="ankle_3", gear="30")
...
def pusher(goal_pos=np.array([0.45, -0.05, -0.323])):
    ...
    r_shoulder_pan_link = worldbody.body(
        name='r_shoulder_pan_link', pos=[0, -.6, 0])
    ...
    r_elbow_flex_link = r_upper_arm_link.body(
        name='r_elbow_flex_link', pos=[0.4, 0, 0])
    ...
    r_forearm_link = r_forearm_roll_link.body(
        name='r_forearm_link', pos=[0, 0, 0])
    r_forearm_link.geom(
        name="fa", type="capsule", fromto="0 0 0 0.291 0 0", size="0.05")

    r_wrist_flex_link = r_forearm_link.body(
        name='r_wrist_flex_link', pos=[0.321, 0, 0])
    ...
    r_wrist_roll_link = r_wrist_flex_link.body(
        name='r_wrist_roll_link', pos=[0, 0, 0])
    ...
    tips_arm.geom(
        name="tip_arml", type="sphere", pos="0.1 -0.1 0.", size="0.01")
    tips_arm.geom(
        name="tip_armr", type="sphere", pos="0.1 0.1 0.", size="0.01")
    ...
    actuator.motor(
        ...
        ctrllimited=True)
    actuator.motor(
        joint="r_elbow_flex_joint", ctrlrange=[-2.0, 2.0], ctrllimited=True)
    actuator.motor(
        joint="r_forearm_roll_joint", ctrlrange=[-2.0, 2.0], ctrllimited=True)
    actuator.motor(
        joint="r_wrist_flex_joint", ctrlrange=[-2.0, 2.0], ctrllimited=True)
    actuator.motor(
        joint="r_wrist_roll_joint", ctrlrange=[-2.0, 2.0], ctrllimited=True)
...
def swimmer():
    ...
    torso.geom(
        density=1000, fromto=[1.5, 0, 0, 0.5, 0, 0], size=0.1, type='capsule')
    ...
    mid.geom(
        density=1000, fromto=[0, 0, 0, -1, 0, 0], size=0.1, type='capsule')
    mid.joint(
        axis=[0, 0, 1],
        limited=True,
        name='rot2',
